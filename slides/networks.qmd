...
## OSI Model
[![](images/networks/OSI_Model_v1.svg){fig-alt="the OSI model"}](https://commons.wikimedia.org/wiki/File:OSI_Model_v1.svg)



## Protocol stack: physical layer
::: {.right-float-img .img-size-800}
[![](images/networks/ethernet-cable.jpg){fig-alt="Ethernet cable"}](https://commons.wikimedia.org/wiki/File:Ethernet_cable._SAM.jpg)
:::
...
[![](images/networks/ethernet-packet.svg){fig-alt="Ethernet packet"}](https://commons.wikimedia.org/wiki/File:Ethernet_Type_II_Frame_format.svg)
...
[![](images/networks/ip-header.png){fig-alt="IPv4 header"}](https://commons.wikimedia.org/wiki/File:IPv4_header_%281%29.png)
...
[![](images/networks/tcp-header.png){fig-alt="TCP header"}](https://commons.wikimedia.org/wiki/File:TCP_header.png)
...
![](https://andromeda.cs.virginia.edu/ics/network-encapsulation.svg){fig-alt="netowrk encapsulation"}
...
[![](images/networks/ECB_encryption.svg){fig-alt="ECB encryption image"}](https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation)



## Encryption with IVs
(at least what should happen)
[![](images/networks/CBC_encryption.svg){fig-alt="CBC encryption image"}](https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation)
...
## Obtaining Wireshark
- Download it at [wireshark.org/download.html](https://www.wireshark.org/download.html)
