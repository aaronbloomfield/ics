...
## OSI Model
[![the OSI model](images/networks/OSI_Model_v1.svg)](https://commons.wikimedia.org/wiki/File:OSI_Model_v1.svg)
...
![netowrk encapsulation](https://andromeda.cs.virginia.edu/ics/network-encapsulation.svg)
...
[![ECB encryption image](images/networks/ECB_encryption.svg)](https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation)



## Encryption with IVs
(at least what should happen)
[![CBC encryption image](images/networks/CBC_encryption.svg)](https://en.wikipedia.org/wiki/Block_cipher_mode_of_operation)
