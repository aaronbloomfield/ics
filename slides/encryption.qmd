...
![an image of a TCP dump](images/encryption/tcpdump.png)
...
## Caesar Cipher
![an image of a Caesar cipher](images/encryption/caesar-cipher.png)
...
![an image of a Vigenere cipher table](images/encryption/vigenere-cipher.png)
...
## Rotor machines
![an image of a rotor machine](images/encryption/rotor-machine.png)
...
## Enigma machine
![a picture of the enigma machine](images/encryption/enigma-machine.png)
...
## Key Round Schedule
[![AES key round images](https://upload.wikimedia.org/wikipedia/commons/b/be/AES-Key_Schedule_128-bit_key.svg){style="width:500px;float:right;margin:10px;border:10px solid white"}](https://commons.wikimedia.org/wiki/File:AES-Key_Schedule_128-bit_key.svg)
...
## AES: ShiftRows step
[![AES key round images: shiftrows step](https://upload.wikimedia.org/wikipedia/commons/6/66/AES-ShiftRows.svg)](https://commons.wikimedia.org/wiki/File:AES-ShiftRows.svg)
...
## AES: MixColumns step
[![AES key round images: mixcolumns step](https://upload.wikimedia.org/wikipedia/commons/7/76/AES-MixColumns.svg)](https://commons.wikimedia.org/wiki/File:AES-MixColumns.svg)
...
[![AES key round images: addroundkey step](https://upload.wikimedia.org/wikipedia/commons/a/ad/AES-AddRoundKey.svg){style="width:600px;float:right;margin:10px;border:10px solid white"}](https://commons.wikimedia.org/wiki/File:AES-AddRoundKey.svg)
...
![Google recruitment billboard](https://statisticallyinsignificant.files.wordpress.com/2011/05/google.jpg)
...
## Security
::: {.stretch}
![xkcd Security comic](https://imgs.xkcd.com/comics/security.png){title="Actual actual reality: nobody cares about his secrets.  (Also, I would be hard-pressed to find that wrench for $5.)" style='border:10px solid white'}  
:::
::: {.r-stack}
...
![an elliptic curve](images/encryption/secp256k1-a.svg)
...
## Random Number
::: {.stretch}
![xkcd on random numbers](https://imgs.xkcd.com/comics/random_number.png){title="RFC 1149.5 specifies 4 as the standard IEEE-vetted random number." style='border:10px solid white'}  
:::
::: {.r-stack}
...
![lava lamps at cloudflare's HQ](http://blog.cloudflare.com/content/images/2017/11/lava-lamps.jpg)
...
## Security Holes
::: {.stretch}
![xkcd on security holes](https://imgs.xkcd.com/comics/security_holes.png){title="True story: I had to try several times to upload this comic because my ssh key was blacklisted." style='border:10px solid white'  }
:::
::: {.r-stack}
...
## Dependency
::: {.stretch}
![xkcd on dependencies](https://imgs.xkcd.com/comics/dependency.png){title="Someday ImageMagick will finally break for good and we&#39;ll have a long period of scrambling as we try to reassemble civilization from the rubble." style='border:10px solid white' srcset="https://imgs.xkcd.com/comics/dependency_2x.png 2x" }
:::
::: {.r-stack}
...
![an image of the Dagapeyeff cipher](images/encryption/dagapeyeff-cipher.png)
:::
...
## 9. Kryptos
::: {.right-float-img .img-size-600}
![an image of Kryptos](https://listverse.com/wp-content/uploads/2007/10/kryptos-tm.jpg)
:::
...
::: {.right-float-img .img-size-600}
![an image of the Shugborough Hall Inscription](http://listverse.com/wp-content/uploads/2007/10/shug4big-tm.jpg)
:::
...
::: {.right-float-img .img-size-600}
![an image of the Chinese Gold Bar Cipher](http://listverse.com/wp-content/uploads/2007/10/10.1-tm.jpg)
:::
...
## 6. Chaocipher
::: {.right-float-img .img-size-600}
![an image of the Chaocipher](http://listverse.com/wp-content/uploads/2007/10/jfb-tm.jpg)
:::
...
::: {.right-float-img .img-size-600}
![an image of the Dorabella Cipher](http://listverse.com/wp-content/uploads/2007/10/elgciph-tm.jpg)
:::
...
## 4. Beale Ciphers
::: {.right-float-img .img-size-600}
![an image of the Beale Ciphers](http://listverse.com/wp-content/uploads/2007/10/700px-beale-1.svg-tm.jpg)
:::
...
## 3. Linear A
::: {.right-float-img .img-size-600}
![an image of Linear A](http://listverse.com/wp-content/uploads/2007/10/lina-tm.jpg)
:::
...
::: {.right-float-img .img-size-600}
![an image of the Voynich Manuscript](http://listverse.com/wp-content/uploads/2007/10/awr-6vm2-tm.jpg)
:::
...
![an image of the Phaistos Disk](http://listverse.com/wp-content/uploads/2007/10/phaistos-tm.jpg)
:::
