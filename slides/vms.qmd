...
## JVM diagram
![](https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/JvmSpec7.png/960px-JvmSpec7.png){fig-alt="java virtual machine image"}
From [here](https://commons.wikimedia.org/wiki/File:JvmSpec7.png)
...
![](https://upload.wikimedia.org/wikipedia/commons/0/09/Docker-linux-interfaces.svg){fig-alt="docker's structure"}{style="width:600px"}
:::
- Docker is popular
  - Also LXC, LXD
- FreeBSD jails
...
::: {style="zoom:175%"}
![](http://flylib.com/books/3/275/1/html/2/images/01fig19.jpg){fig-alt="VM/370 structure"}
:::
...
![](https://cdn-images-1.medium.com/max/1600/1*RKPXdVaqHRzmQ5RPBH_d-g.png){fig-alt="hosted vm"}
:::
- Hosted VM
  - VM runs on OS
  - VMWare, VirtualBox
...
## ABI vs API
![](https://upload.wikimedia.org/wikipedia/commons/thumb/b/bb/Linux_API_and_Linux_ABI.svg/800px-Linux_API_and_Linux_ABI.svg.png){fig-alt="abi vs api"}
...
## User mode vs Kernel mode
- If a guest OS tries a privileged operation:
...
- VMs tend to run the guest OS in user mode
  - But the OSs think they are running on hardware, so they will attempt to do "privileged" things (like access hardware directly)
- The Virtual Machine Monitor (VMM) handles this
  - It is typically a device driver running in kernel mode
...
## VMM diagram
::: {style="zoom:150%"}
![](http://www.ni.com/cms/images/devzone/tut/HostedVirtualizationSmall_20090325191230.PNG){fig-alt="a virtual machine monitor diagram"}
:::
...
## Hosted VM: VMWare
![](https://www.vmware.com/content/dam/digitalmarketing/vmware/en/images/gallery/thumbnails/tn-workstation-pro-16.jpg){fig-alt="vmware hosting lots of vms"}
...
## virt-what
![](images/vms/virt-what.png){fig-alt="a screenshot of virt-what"}
...
## VM Break-out
![](images/vms/vm-breakout.png){fig-alt="vm break out"}
