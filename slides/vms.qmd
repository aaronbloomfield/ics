...
## JVM diagram
![java virtual machine image](https://upload.wikimedia.org/wikipedia/commons/thumb/d/dd/JvmSpec7.png/960px-JvmSpec7.png)
...
![docker's structure](https://upload.wikimedia.org/wikipedia/commons/0/09/Docker-linux-interfaces.svg){style="width:600px"}
:::
- Docker is popular
  - Also LXC, LXD
- FreeBSD jails
...
::: {style="zoom:175%"}
![VM/370 structure](http://flylib.com/books/3/275/1/html/2/images/01fig19.jpg)
:::
...
## VMM diagram
::: {style="zoom:150%"}
![a virtual machine monitor diagram](http://www.ni.com/cms/images/devzone/tut/HostedVirtualizationSmall_20090325191230.PNG)
:::
...
## Hosted VM: VMWare
![vmware hosting lots of vms](https://www.vmware.com/content/dam/digitalmarketing/vmware/en/images/gallery/thumbnails/tn-workstation-pro-16.jpg)
...
## virt-what
![a screenshot of virt-what](images/vms/virt-what.png)
