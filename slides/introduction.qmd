...
![CIH virus pop-up screen shot](https://upload.wikimedia.org/wikipedia/commons/0/07/CIH.png)
:::
<!-- -->
...
![Anna Kournikova](https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Anna_Kournikova-Bagram_Airfield_2009.jpg/500px-Anna_Kournikova-Bagram_Airfield_2009.jpg)
:::
...
::: {.right-float-img .img-size-500}
![uranium gas centrifuges](images/stuxnet/960px-Gas_centrifuge_cascade.jpg)
:::
...
![ashley madison's logo](https://upload.wikimedia.org/wikipedia/commons/3/3a/Ashley_madison_logo.png)
...
::: {.right-float-img .img-size-500}
![an image of a sign saying 'vote here'](https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Vote_Here_sign%2C_Louisiana%2C_March_2025.jpg/500px-Vote_Here_sign%2C_Louisiana%2C_March_2025.jpg)
:::
...
::: {.right-float-img .img-size-500}
![an image of a notpetya screen shot](https://upload.wikimedia.org/wikipedia/commons/6/65/2017_Petya_cyberattack_screenshot.png)
:::
...
::: {.right-float-img .img-size-500}
![an image of a gas pipeline](https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Rohre_des_Pumpspeicherkraftwerks_Geesthacht.JPG/960px-Rohre_des_Pumpspeicherkraftwerks_Geesthacht.JPG)
:::
...
## A UVa hack (2013)
::: {.img-size-700}
[![UVA's website after being hacked](images/introduction/root-the-box-uva-hack.png)](http://www.c-ville.com/anatomy-of-a-hack-examining-root-the-boxs-attack-on-uvas-website/#.WZz6w3XythE)
:::
...
::: {.img-size-700}
[![an article about another UVA hack](images/introduction/uva-chinese-hack.png)](http://www.thedailybeast.com/chinese-hackers-target-us-university-with-government-ties)
:::


## Yet another UVa hack (2016)
::: {.img-size-700}
[![yet another article about UVA being hacked](images/introduction/uva-phishing-hack.png)](https://www.washingtonpost.com/news/grade-point/wp/2016/01/22/phishing-hack-at-the-university-of-virginia-compromises-employee-computer-records/)
:::
...
::: {.right-float-img .img-size-500}
![an image of the morris worm display at a computer museum](https://upload.wikimedia.org/wikipedia/commons/b/b6/Morris_Worm.jpg)
:::
...
![ACM code of ethics screenshot](https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Association_for_Computing_Machinery_%28ACM%29_logo.svg/768px-Association_for_Computing_Machinery_%28ACM%29_logo.svg.png)
:::
