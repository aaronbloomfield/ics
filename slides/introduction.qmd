...
![](https://upload.wikimedia.org/wikipedia/commons/0/07/CIH.png){fig-alt="CIH virus pop-up screen shot"}
:::
<!-- -->
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Anna_Kournikova-Bagram_Airfield_2009.jpg/500px-Anna_Kournikova-Bagram_Airfield_2009.jpg){fig-alt="Anna Kournikova"}
:::
...
::: {.right-float-img .img-size-500}
![](images/stuxnet/960px-Gas_centrifuge_cascade.jpg){fig-alt="uranium gas centrifuges"}
:::
...
![](https://upload.wikimedia.org/wikipedia/commons/3/3a/Ashley_madison_logo.png){fig-alt="ashley madison's logo"}
...
::: {.right-float-img .img-size-500}
![](https://upload.wikimedia.org/wikipedia/commons/thumb/3/38/Vote_Here_sign%2C_Louisiana%2C_March_2025.jpg/500px-Vote_Here_sign%2C_Louisiana%2C_March_2025.jpg){fig-alt="an image of a sign saying 'vote here'"}
:::
...
::: {.right-float-img .img-size-500}
![](https://upload.wikimedia.org/wikipedia/commons/6/65/2017_Petya_cyberattack_screenshot.png){fig-alt="an image of a notpetya screen shot"}
:::
...
::: {.right-float-img .img-size-500}
![](https://upload.wikimedia.org/wikipedia/commons/thumb/f/f3/Rohre_des_Pumpspeicherkraftwerks_Geesthacht.JPG/960px-Rohre_des_Pumpspeicherkraftwerks_Geesthacht.JPG){fig-alt="an image of a gas pipeline"}
:::
...
## A UVa hack (2013)
::: {.img-size-700}
[![](images/introduction/root-the-box-uva-hack.png){fig-alt="UVA's website after being hacked"}](http://www.c-ville.com/anatomy-of-a-hack-examining-root-the-boxs-attack-on-uvas-website/#.WZz6w3XythE)
:::
...
::: {.img-size-700}
[![](images/introduction/uva-chinese-hack.png){fig-alt="an article about another UVA hack"}](http://www.thedailybeast.com/chinese-hackers-target-us-university-with-government-ties)
:::


## Yet another UVa hack (2016)
::: {.img-size-700}
[![](images/introduction/uva-phishing-hack.png){fig-alt="yet another article about UVA being hacked"}](https://www.washingtonpost.com/news/grade-point/wp/2016/01/22/phishing-hack-at-the-university-of-virginia-compromises-employee-computer-records/)
:::
...
- Grades
  - Two midterms (15% each) (dates in [syllabus](../uva/syllabus.html))
...
::: {.right-float-img .img-size-500}
![](https://upload.wikimedia.org/wikipedia/commons/b/b6/Morris_Worm.jpg){fig-alt="an image of the morris worm display at a computer museum"}
:::
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/8/8e/Association_for_Computing_Machinery_%28ACM%29_logo.svg/768px-Association_for_Computing_Machinery_%28ACM%29_logo.svg.png){fig-alt="ACM code of ethics screenshot"}
:::
