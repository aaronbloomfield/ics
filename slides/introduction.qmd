---
title: "Intro to Cybersecurity:<br>Course Introduction"
subtitle: "(subtitle)"
---
...
<img class="stretch" src="images/introduction/root-the-box-uva-hack.png" alt="uva hack image">
(<a href="http://www.c-ville.com/anatomy-of-a-hack-examining-root-the-boxs-attack-on-uvas-website/#.WZz6w3XythE">source</a>)



## Another UVa hack (2015)

<img class="stretch" src="images/introduction/uva-chinese-hack.png" alt="uva hack image">
(<a href="http://www.thedailybeast.com/chinese-hackers-target-us-university-with-government-ties">source</a>)
...
<img class="stretch" src="images/introduction/uva-phishing-hack.png" alt="uva hack image">
(<a href="https://www.washingtonpost.com/news/grade-point/wp/2016/01/22/phishing-hack-at-the-university-of-virginia-compromises-employee-computer-records/">source</a>)
...
- We'll use for:
  ...
  - Assignments and grades will be duplicated there
...
<!--
- You have to have a network card that is compatible with [Aircrack-ng](https://www.aircrack-ng.org/) for one of the homeworks
  - If yours is not compatible (and many are not), you can buy one that is for about $20 via Amazon
  - Information on this will be provided part-way through the semester, in time for the appropriate homework
-->
## Politics
