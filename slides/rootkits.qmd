...
::: {style="zoom:125%"}
![a screenshot of hidden files in RootkitRevealer](images/rootkits/120874iADC4E49896E0D0DA.webp)
:::
...
::: {style="zoom:150%"}
![a screenshot of the kernel function pointers with a few clearly indicated as being out of the expected range](images/rootkits/120875i356D5B86892D50CA.webp)
:::
...
::: {style="zoom:150%"}
![a screenshot of a windows command prompt showing the device driver files](images/rootkits/120877iF162AA11C8819F51.webp)
:::
...
![the CD album cover that caused all of this](https://m.media-amazon.com/images/I/81GEYZrDJBL._SS500_.jpg)
...
::: {style="zoom:150%"}
![a screenshot of how the DRMServer.exe application appears in Windows' task manager](images/rootkits/120882iB7E2EE5C2ABE9DA1.webp)
:::
...
::: {style="zoom:150%"}
![a screenshot of MediaJam in add-or-remove-programs in windows](images/rootkits/120890i6BD0152633D058EB.webp)
:::
