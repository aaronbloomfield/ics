...
::: {.stretch}
![](https://imgs.xkcd.com/comics/security.png){fig-alt="xkcd on unbreakable security"}{title="Actual actual reality: nobody cares about his secrets.  (Also, I would be hard-pressed to find that wrench for $5.)" style='border:10px solid white'}  
:::
::: {.r-stack}
...
![](images/security-mindset/road-block.jpg){fig-alt="an image of a terrible road block"}

----

![](images/security-mindset/lock.jpg){fig-alt="an image of an ineffective lock"}
...
## A pin tumbler lock
![](images/security-mindset/Pin_tumbler_no_key.svg){fig-alt="an image of a pin tumbler lock"}
...
## With a wrong key
![](images/security-mindset/Pin_tumbler_bad_key.svg){fig-alt="an image of a pin tumbler lock"}
The pins are not aligned so the plug can't rotate



## With the right key
![](images/security-mindset/Pin_tumbler_with_key.svg){fig-alt="an image of a pin tumbler lock"}
Note that the 'breaks' between the pins are lined up



## Unlocked lock
![](images/security-mindset/Pin_tumbler_unlocked.svg){fig-alt="an image of a pin tumbler lock"}
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/California_Bungalow.jpg/1280px-California_Bungalow.jpg){fig-alt="an image of a poorly secured house"}
...
![](images/security-mindset/rally-166.jpg){fig-alt="an image of the unite the right rally in charlottesville in 2017"}
...
![](images/security-mindset/rally-183.jpg){fig-alt="an image of the unite the right rally in charlottesville in 2017"}
...
![](images/security-mindset/rally-119.jpg){fig-alt="an image of the unite the right rally in charlottesville in 2017"}
