...
::: {.stretch}
![xkcd on unbreakable security](https://imgs.xkcd.com/comics/security.png){title="Actual actual reality: nobody cares about his secrets.  (Also, I would be hard-pressed to find that wrench for $5.)" style='border:10px solid white'}  
:::
::: {.r-stack}
...
![an image of a terrible road block](images/security-mindset/road-block.jpg)

----

![an image of an ineffective lock](images/security-mindset/lock.jpg)
...
## A pin tumbler lock
![an image of a pin tumbler lock](images/security-mindset/Pin_tumbler_no_key.svg)
...
## With a wrong key
![an image of a pin tumbler lock](images/security-mindset/Pin_tumbler_bad_key.svg)
The pins are not aligned so the plug can't rotate



## With the right key
![an image of a pin tumbler lock](images/security-mindset/Pin_tumbler_with_key.svg)
Note that the 'breaks' between the pins are lined up



## Unlocked lock
![an image of a pin tumbler lock](images/security-mindset/Pin_tumbler_unlocked.svg)
...
![an image of a poorly secured house](https://upload.wikimedia.org/wikipedia/commons/thumb/d/d0/California_Bungalow.jpg/1280px-California_Bungalow.jpg)
...
![an image of the unite the right rally in charlottesville in 2017](images/security-mindset/rally-166.jpg)
...
![an image of the unite the right rally in charlottesville in 2017](images/security-mindset/rally-183.jpg)
...
![an image of the unite the right rally in charlottesville in 2017](images/security-mindset/rally-119.jpg)
