...
[![](images/web-security/Diffie-Hellman_Key_Exchange.svg){fig-alt="Image of mixing paint colors"}](https://commons.wikimedia.org/wiki/File:Diffie-Hellman_Key_Exchange.svg)
:::
...
![](images/web-security/x.509-cert.svg){fig-alt="Diagram of an X.509 certificate for google.com"}



## Certificate usage
::: {.right-float-img .img-size-600}
![](images/web-security/ServerCertificate.png){fig-alt="Screenshot of a Firefox pop-up of wikipedia.com's certificate"}
:::
...
<a href='https://commons.wikimedia.org/wiki/File:Chain_of_trust_v2.svg'><img src='https://upload.wikimedia.org/wikipedia/commons/8/87/Chain_of_trust_v2.svg' style='width:80%;padding:10px' alt='image of a https certificate chain'></a>
...
<img src="images/web-security/uva-cert-trust.webp" style="float:right;width:250px;margin-left:20px;height:unset" alt='iPhone screenshot of certificate trust for UVA's certificate'>
...
::: {.stretch}
[![](images/web-security/SSL_handshake_with_two_way_authentication_with_certificates.svg){fig-alt="TLS protocol diagram"}](https://upload.wikimedia.org/wikipedia/commons/a/ae/SSL_handshake_with_two_way_authentication_with_certificates.svg)
:::
...
::: {.stretch}
![](images/web-security/tls-protocols-1.webp){fig-alt="a list of TLS key exchange protocols"}
:::
...
::: {.stretch}
![](images/web-security/tls-protocols-2.png){fig-alt="a list of TLS session protocols"}
:::
Updated version [here](https://en.wikipedia.org/wiki/Transport_Layer_Security#Key_exchange_or_key_agreement)
...
::: {style="zoom:200%"}
![](images/web-security/IVs.svg){fig-alt="a diagram of the use of IVs (initialization vector) in encryption"}
:::
...
[![](images/web-security/SHAhmac.svg){fig-alt="how an HMAC with SHA1 is encoded"}](https://commons.wikimedia.org/wiki/File:SHAhmac.svg)
:::
...
![](images/web-security/tls-protocols-3.png){fig-alt="TLS MAC protocols"}
...
## Heartbleed (2012)
::: {.right-float-img .img-size-600}
![](images/web-security/Heartbleed.svg){fig-alt="the heartbleed attack logo"}
:::
...
![](images/web-security/heartbleed_explanation_2x-a.png){fig-alt="xkcd heartbleed comic, first third"}

## xkcd on Heartbleed ([# 1354](https://xkcd.com/1354/))
![](images/web-security/heartbleed_explanation_2x-b.png){fig-alt="xkcd heartbleed comic, second third"}

## xkcd on Heartbleed ([# 1354](https://xkcd.com/1354/))
![](images/web-security/heartbleed_explanation_2x-c.png){fig-alt="xkcd heartbleed comic, third third"}
...
![](images/web-security/weakkeys12.extended.svg){fig-alt="a graph showing boot-up time versus PRG quality"}
...
## Cookie exchange
[![](images/web-security/800px-HTTP_cookie_exchange.svg.png){fig-alt="a diagram showing the communication involved in cookie exchange"}](https://commons.wikimedia.org/wiki/File:HTTP_cookie_exchange.svg)



## What a cookie stores
::: {.right-float-img style="zoom:200%"}
[![](images/web-security/HTTP-Cookie-Google.svg){fig-alt="a screenshot of HTTP headers which shows the cookie data"}](https://commons.wikimedia.org/wiki/File:HTTP-Cookie-Google.svg)
:::
...
- Those tiny little icons to encourage you to share that page on social media: <img src="images/web-security/social-media-comments.png" style="width:600px" alt="a facebook comment box">
...
<img src="https://upload.wikimedia.org/wikipedia/commons/0/0f/Aegis_Authenticator_3.2_screenshot.png" style="float:right;margin-left:20px;width:250px;height:unset" alt='a screenshot of a 2FA application on an iPhone'>
...
<img src="https://upload.wikimedia.org/wikipedia/commons/thumb/b/b3/Wells_Fargo_2FA_RSA_Token_-_Two_Factor_Authentication_-_Six_Digit_Code_%2853370207137%29.jpg/960px-Wells_Fargo_2FA_RSA_Token_-_Two_Factor_Authentication_-_Six_Digit_Code_%2853370207137%29.jpg" style="float:right;margin-left:20px;height:unset;width:400px" alt='a picture of an RSA key for 2FA'>
...
- Six values are set:
  ...
  - The time interval $T_x$, typically 30 seconds
- Algorithm
...
<img src="https://docs.swrve.com/wp-content/uploads/2018/10/QRcode-replace.jpg" style="float:right;width:400px;height:unset;margin-left:20px;padding:10px" alt='a QR code for configuring 2FA authentication'>
...
- Use Duo Mobile (or another authenticator) instead of SMS for your 2FA
  ...
  - It's on your phone, so requires biometrics to access
