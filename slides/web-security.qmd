...
- Each side may increment independently
  - The authenticator will try the next few counters just in case
...
- To prevent exploiting this via a brute-force attack:
  - Throttle attempts: block after too many failed attempts or linearly increase the delay after each failed attempt
...
- Use Duo Mobile (or another authenticator) instead of SMS for your 2FA
  ...
  - The data is sent encrypted, unlike SMS
