...
[![Image of mixing paint colors](images/web-security/Diffie-Hellman_Key_Exchange.svg)](https://commons.wikimedia.org/wiki/File:Diffie-Hellman_Key_Exchange.svg)
:::
...
![Diagram of an X.509 certificate for google.com](images/web-security/x.509-cert.svg)



## Certificate usage
::: {.right-float-img .img-size-600}
![Screenshot of a Firefox pop-up of wikipedia.com's certificate](images/web-security/ServerCertificate.png)
:::
...
::: {.stretch}
[![TLS protocol diagram](images/web-security/SSL_handshake_with_two_way_authentication_with_certificates.svg)](https://upload.wikimedia.org/wikipedia/commons/a/ae/SSL_handshake_with_two_way_authentication_with_certificates.svg)
:::
...
::: {.stretch}
![a list of TLS key exchange protocols](images/web-security/tls-protocols-1.webp)
:::
...
::: {.stretch}
![a list of TLS session protocols](images/web-security/tls-protocols-2.png)
:::
Updated version [here](https://en.wikipedia.org/wiki/Transport_Layer_Security#Key_exchange_or_key_agreement)
...
::: {style="zoom:200%"}
![a diagram of the use of IVs (initialization vector) in encryption](images/web-security/IVs.svg)
:::
...
[![how an HMAC with SHA1 is encoded](images/web-security/SHAhmac.svg)](https://commons.wikimedia.org/wiki/File:SHAhmac.svg)
:::
...
## Heartbleed (2012)
::: {.right-float-img .img-size-600}
![the heartbleed attack logo](images/web-security/Heartbleed.svg)
:::
...
![xkcd heartbleed comic, first third](images/web-security/heartbleed_explanation_2x-a.png)

## xkcd on Heartbleed ([# 1354](https://xkcd.com/1354/))
![xkcd heartbleed comic, second third](images/web-security/heartbleed_explanation_2x-b.png)

## xkcd on Heartbleed ([# 1354](https://xkcd.com/1354/))
![xkcd heartbleed comic, third third](images/web-security/heartbleed_explanation_2x-c.png)
...
![a graph showing boot-up time versus PRG quality](images/web-security/weakkeys12.extended.svg)
...
## Cookie exchange
[![a diagram showing the communication involved in cookie exchange](images/web-security/800px-HTTP_cookie_exchange.svg.png)](https://commons.wikimedia.org/wiki/File:HTTP_cookie_exchange.svg)



## What a cookie stores
::: {.right-float-img style="zoom:200%"}
[![a screenshot of HTTP headers which shows the cookie data](images/web-security/HTTP-Cookie-Google.svg)](https://commons.wikimedia.org/wiki/File:HTTP-Cookie-Google.svg)
:::
