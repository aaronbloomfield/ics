...
![](images/anonymity/cypherpunks.jpg){fig-alt="image of a PGP email signature"}
:::
...
- As for S:
  - If the destination is *outside* of Tor, then it sends the data (via TLS) to the destination, and S is called the *exit relay*
...
![](images/anonymity/Silk_Road_Marketplace_Item_Screen.jpg){fig-alt="screenshot of the silk road dark web site"}
:::
...
- Ross Ulbricht, alleged to be DPR, was arrested in Oct 2, 2013
  - The FBI seized about $90 million in bitcoins
...
## Tor: The Drawbacks
- This is how evil stuff is propagated online
