...
- Briefly, internationally:
  - From the UN: [Half of all countries aware but lacking national plan on cybersecurity, UN agency reports](https://news.un.org/en/story/2017/07/560922-half-all-countries-aware-lacking-national-plan-cybersecurity-un-agency-reports) (from July 2017)
  - The UN has focused on cybersecurity policy, [as early as 2011](http://www.un.org/en/development/desa/news/ecosoc/cybersecurity-demands-global-approach.html)
...
- Consider the recent testimony of Facebook's Mark Zuckerberg before Congress on April 10, 2018
  - This was in response to the [Cambridge Analytica data scandal](https://en.wikipedia.org/wiki/Facebook%E2%80%93Cambridge_Analytica_data_scandal) and Facebook's role in it
- The video on the next slide is 1:00 long ([direct link](https://www.youtube.com/embed/n2H8wx1aBiQ?rel=0))



----

<iframe class="stretch" src="https://www.youtube.com/embed/n2H8wx1aBiQ?rel=0" data-autoplay></iframe>
<p><a href='https://www.youtube.com/embed/n2H8wx1aBiQ?rel=0'>direct link</a></p>
...
- The video on the next slide is 2:29 long ([direct link](https://www.youtube.com/embed/f99PcP0aFNE?rel=0))



----

<iframe class="stretch" src="https://www.youtube.com/embed/lTonHRerMC4?rel=0" data-autoplay></iframe>
<p><a href='https://www.youtube.com/watch?v=lTonHRerMC4?rel=0'>direct link</a></p>
...
## Challenge 1: lack of congressional tech savvy
- Consider the [Burr-Feinstein Anti-Encryption Bill](https://www.burr.senate.gov/imo/media/doc/BAG16460.pdf) from April of 2016
...
- The [bill was declared dead](https://www.eff.org/deeplinks/2016/05/win-one-security-burr-feinstein-proposal-declared-dead-year) in May 2016
- Sources: [1](https://techcrunch.com/2016/04/13/burr-feinstein-encryption-bill-is-officially-here-in-all-its-scary-glory/), [2](https://www.justsecurity.org/30606/burr-feinstein-crypto-bill-terrible/), [3](https://www.justsecurity.org/30606/burr-feinstein-crypto-bill-terrible/), [4](https://www.techdirt.com/articles/20160408/08381934131/burr-feinstein-release-their-anti-encryption-bill-more-ridiculous-than-expected.shtml), etc.
...
- Consider the 2015 [OMB](https://en.wikipedia.org/wiki/Office_of_Management_and_Budget)'s [HTTPS-Only Standard directive](https://obamawhitehouse.archives.gov/sites/default/files/omb/memoranda/2015/m-15-13.pdf):
...
- From the US Constitution's Bill of Rights, amendment 10:
...
- Many examples:
  ...
  - The NSA collected many exploits and did not tell the OS makers about them
    ...
    - When those [tools were leaked](https://en.wikipedia.org/wiki/The_Shadow_Brokers), additional malware made use of these exploits
  - The [White House eliminated the administration's cybersecurity coordinator](https://www.darkreading.com/vulnerabilities---threats/us-government-cybersecurity-at-a-crossroads/d/d-id/1331815) in May 2018



## Challenge 7: Who fixes this?
- Executive branch: the president can issue an [executive order](https://en.wikipedia.org/wiki/Executive_order)
  - They are limited (by design) in their scope
  - Some of this power is relegated to certain departments, such as [DHS](https://en.wikipedia.org/wiki/United_States_Department_of_Homeland_Security)
...
- [SOPA](https://en.wikipedia.org/wiki/Stop_Online_Piracy_Act) and [PIPA](https://en.wikipedia.org/wiki/Personal_Information_Protection_and_Electronic_Documents_Act) from 2012, which were heavily lobbied by the [MPAA](https://en.wikipedia.org/wiki/Motion_Picture_Association_of_America) and the [RIAA](https://en.wikipedia.org/wiki/Recording_Industry_Association_of_America), would have invalidated [DNSSEC](https://en.wikipedia.org/wiki/Domain_Name_System_Security_Extensions)
...
- In 2018, a typical starting salary for a *good* CS graduate with a bachelor's:
  ...
  - $53k in 2023 with the gov't -- yes, that's fifty-three
    - A bachelor's is GS-7 (or lower), [calculated](https://www.opm.gov/policy-data-oversight/pay-leave/salaries-wages/2016/general-schedule-gs-salary-calculator/) in the (very expensive!) DC area
...
- This is why the gov't hires contractors, who can pay competitive rates
  - But that causes lots of other issues, such as:
	...
	- Issues like the [Snowden leak](https://en.wikipedia.org/wiki/Snowden_leak)
	- Contractors lobbying the gov't for unnecessary contracts
	  - Like the [terrible website roll-out of the Affordable Care Act's HealthCare.gov site](https://en.wikipedia.org/wiki/HealthCare.gov#Concerns_about_the_website)
...
- The 2018-2019 [government shutdown](https://en.wikipedia.org/wiki/United_States_federal_government_shutdown_of_2018%E2%80%932019) lasted 35 days
...
- [source](https://rollcall.com/2019/01/10/cybersecurity-may-suffer-as-shutdown-persists/)
...
# Case Study: [SOPA](https://en.wikipedia.org/wiki/Stop_Online_Piracy_Act) & [PIPA](https://en.wikipedia.org/wiki/Personal_Information_Protection_and_Electronic_Documents_Act)
...
- SOPA and PIPA were "postponed" in 2012
  ...
  - Example: [The Burr-Feinstein anti-encryption bill of 2016](https://www.techdirt.com/articles/20160408/08381934131/burr-feinstein-release-their-anti-encryption-bill-more-ridiculous-than-expected.shtml)
...
- [eWeek stated](http://www.eweek.com/cloud/house-sopa-hearings-reveal-anti-internet-bias-on-committee-witness-list):
...
- Read [here for more info](http://en.wikipedia.org/wiki/Wikipedia:SOPA_initiative/Learn_more)
...
## A non-US example
- The [EU](https://en.wikipedia.org/wiki/European_Union) voted on Sep 12, 2018 for the [Internet Copyright Directive](https://en.wikipedia.org/wiki/Copyright_Directive)
...
- A brief history of cybersecurity policy in the US
  - Sources: [WP article from 2003](http://www.washingtonpost.com/wp-dyn/articles/A50606-2002Jun26.html)



## 1970's
- 1977: the [GAO](https://www.gao.gov/) recommends "limiting the number of federal employees who can use a computer as a way to prevent network security breaches"
- 1977: a [bill](https://www.congress.gov/bill/95th-congress/senate-bill/1766) is introduced which tries to define computer crimes
...
- 1983: hearings on the [414s](https://en.wikipedia.org/wiki/The_414s) and their cyberattacks
- 1987: [Computer Security Act of 1987](https://en.wikipedia.org/wiki/Computer_Security_Act_of_1987) is passed, which intended to improve the security of federal computer systems
  - Was not particularly effective, and was repealed in 2002
- 1988: [Morris worm](https://en.wikipedia.org/wiki/Morris_worm) released
- 1988: In response, [CERT/CC](https://www.ready.gov/community-emergency-response-team) is founded at [CMU](https://www.cmu.edu)



## 1990's
- Viruses increase in power, and awareness of them increases
- People start worrying (later panicking) about [Y2K](https://en.wikipedia.org/wiki/Year_2000_problem)
...
- 1998: the [DMCA](https://en.wikipedia.org/wiki/Digital_Millennium_Copyright_Act) passed to attempt to prevent Internet piracy
  - It weakened cybersecurity and research ([details](https://en.wikipedia.org/wiki/Digital_Millennium_Copyright_Act#Criticisms))



## 2000's
- 2000: Clinton releases the first [cybersecurity strategy](https://clintonwhitehouse4.archives.gov/WH/Work/021600.html) which is generally slammed
- 2000: Various malware raises awareness, and DDOS attacks take down major websites
- 2002: [FISMA](https://en.wikipedia.org/wiki/Federal_Information_Security_Management_Act_of_2002) which focuses on federal agency information security
- 2003: The 9/11 attacks spurred the creation of [DHS](https://www.dhs.gov/), which created [US-CERT](https://en.wikipedia.org/wiki/United_States_Computer_Emergency_Readiness_Team) based on [CERT/CC](https://en.wikipedia.org/wiki/CERT_Coordination_Center)
- Decade-long events:
...
## 2010's
- 2010: [Stuxnet](https://en.wikipedia.org/wiki/Stuxnet) released to disable Iran's nuclear enrichment program
- 2012: [SOPA](https://en.wikipedia.org/wiki/Stop_Online_Piracy_Act) and [PIPA](https://en.wikipedia.org/wiki/Personal_Information_Protection_and_Electronic_Documents_Act)
- 2013: The Pentagon become more public about [seeking to weaponize cyberspace](https://www.npr.org/2013/02/11/171677247/pentagon-goes-on-the-offensive-against-cyber-attacks)
- Many laws passed (see [here](https://blog.appknox.com/a-glance-at-the-united-states-cyber-security-laws/) for a list of some)
  - Limited effect, though
- Budget cuts resulting from the [great recession](https://en.wikipedia.org/wiki/Great_Recession) resulted in little funding
...
- By President Trump in December 2017 ([online PDF](https://www.whitehouse.gov/wp-content/uploads/2017/12/NSS-Final-12-18-2017-0905.pdf))
...
- Formally, "Keep America Safe in the Cyber Era"
  - From Pillar I, page 12 of the [US NSS pdf](https://www.whitehouse.gov/wp-content/uploads/2017/12/NSS-Final-12-18-2017-0905.pdf)
- Priority actions 
...
- Formally, "Lead in Research, Technology, Invention, and Innovation"
  - From Pillar II, page 20 of the [US NSS pdf](https://www.whitehouse.gov/wp-content/uploads/2017/12/NSS-Final-12-18-2017-0905.pdf)
- Priority actions
...
- Formally, "Promote and Protect the U.S. National Security Innovation Base"
  - From Pillar II, page 21 of the [US NSS pdf](https://www.whitehouse.gov/wp-content/uploads/2017/12/NSS-Final-12-18-2017-0905.pdf)
- Priority actions
...
- Formally, "Renew Capabilities: Cyberspace"
  - From Pillar III, page 31 of the [US NSS pdf](https://www.whitehouse.gov/wp-content/uploads/2017/12/NSS-Final-12-18-2017-0905.pdf)
- Priority actions
...
- The charge of [NIST's](https://www.nist.gov/) Commission on Enhancing National Cybersecurity:
...
- Their [report](https://www.nist.gov/sites/default/files/documents/2016/12/02/cybersecurity-commission-report-final-post.pdf) listed 6 imperatives
...
- International Strategy For Cyberspace ([online pdf](https://obamawhitehouse.archives.gov/sites/default/files/rss_viewer/international_strategy_for_cyberspace.pdf)) by President Obama from 2011
...
- These were known as the [Iraqi war logs](https://en.wikipedia.org/wiki/Iraq_War_documents_leak) and the [Afghan war logs](https://en.wikipedia.org/wiki/Afghan_War_documents_leak)



## Manning: the reveal
- 66k civilian deaths out of the 109k recorded deaths
  - The [Iraq Body Count project](https://www.iraqbodycount.org/) estimates about 80% of all deaths in Iraq were civilian deaths
- "[US authorities failed to investigate hundreds of reports of abuse, torture, rape and even murder by Iraqi police and soldiers](https://www.theguardian.com/world/2010/oct/22/iraq-war-logs-military-leaks)"
- Even after [Abu Ghraib](https://en.wikipedia.org/wiki/Abu_Ghraib_torture_and_prisoner_abuse), "abuse of prisoners or detainees by Iraqi security forces continued"
- Many civilian deaths ([1](https://www.aljazeera.com/secretiraqfiles/2010/10/2010102216241633174.html), [2](https://www.nytimes.com/2010/10/24/world/middleeast/24contractors.html?_r=1&hp&mtrref=en.wikipedia.org&gwh=2CEF6AA1EBD3109426A58FAA502B8F9A&gwt=pay), [3](http://www.iraqwarlogs.com/2010/10/22/us-commits-%E2%80%9Cwar-crime%E2%80%9D-as-apache-helicopter-cleared-to-gun-surrendering-insurgents/), etc.)
...
## Edward Snowden: 2013
- [Edward Snowden](https://en.wikipedia.org/wiki/Edward_Snowden) was a contractor with Booz Allen Hamilton
...
[Washington Post, Dec 23, 2013](https://www.washingtonpost.com/world/national-security/edward-snowden-after-months-of-nsa-revelations-says-his-missions-accomplished/2013/12/23/49fc36de-6c1c-11e3-a523-fe73f0ff6b8d_story.html)
...
- Foreign govt's got lots of heat
  ...
  - Some foreign gov'ts actually *increased* their surveillance in some situations (example: [Germany](https://www.theguardian.com/world/2013/nov/02/nsa-portrait-total-surveillance))
...
- Booz Allen Hamilton hired Snowden
  ...
  - He was [insufficiently vetted](https://www.dailydot.com/layer8/edward-snowden-vetted-usis-lawsuit-settlement/)
  - "[USIS did not conduct a thorough or proper investigation into Snowden's background](https://mic.com/articles/50417/edward-snowden-a-private-contractor-gave-snowden-his-security-clearance-and-missed-the-red-flags#.vk3evHgyk)"
...
- Some of the cyberweapons were used in major malware in 2017:
  ...
  - [Petya cyberattack](https://en.wikipedia.org/wiki/2017_Petya_cyberattack)
- [DoublePulsar](https://en.wikipedia.org/wiki/DoublePulsar) infected 200,000 Windows machines in weeks
...
- These weapons were used for the [2019 Baltimore ransomware attack](https://en.wikipedia.org/wiki/2019_Baltimore_ransomware_attack)
...
- Suspicion has fallen on [Harold Martin III](https://en.wikipedia.org/wiki/Harold_T._Martin_III), a contractor for [Booz Allen Hamilton](https://en.wikipedia.org/wiki/Booz_Allen_Hamilton)
...
- On Martin, if he did do it:
  - [US gov't agencies ... failed to ... respond to a number of issues with Martin's security practices and behaviors over a period of 10 to 20 years](https://en.wikipedia.org/wiki/Harold_T._Martin_III)
...
- In 2017, she released a confidential report about the [Russian interference in the 2016 United States elections](https://en.wikipedia.org/wiki/Russian_interference_in_the_2016_United_States_elections)
...
- "[The report suggested that Russian hackers had accessed at least one U.S. voting software supplier](https://en.wikipedia.org/wiki/Reality_Winner)"



## <a href='https://www.cnn.com/2016/12/26/us/2016-presidential-campaign-hacking-fast-facts/index.html'>Election interference: timeline</a>
...
- June 5, 2017: The Intercept publishes [a report on actual hacking of the election](https://theintercept.com/2017/06/05/top-secret-nsa-report-details-russian-hacking-effort-days-before-2016-election/)
  - Previously it was thought (publicly) to be "influencing" only, not hacking of election machines



## Election interference: <br> the US does it too!
- The CIA has long been known to interfere with elections (etc.)
- The [overthrow of the popular and democratically elected Iranian prime minister in 1953](https://en.wikipedia.org/wiki/1953_Iranian_coup_d%27%C3%A9tat)
  - The CIA-installed Shah was so unpopular, it lead to the [1979 Iranian revolution](https://en.wikipedia.org/wiki/Iranian_Revolution)
  - The Iranian gov't still hates us...
- The [CIA overthrew the democratically elected Guatemalan president in 1954](https://en.wikipedia.org/wiki/1954_Guatemalan_coup_d%27%C3%A9tat)
- The [list goes on and on](https://en.wikipedia.org/wiki/Foreign_electoral_intervention)...



## Election interference: <br> are they equivalent?
- Some would say yes
...
## Election interference: <br> errors made
...
- Many election machines are vulnerable
  ...
  - They are [regularly exploited at DefCon](https://www.newyorker.com/news/dispatch/election-hacking-lessons-from-the-2018-def-con-hackers-conference)
- "[local officials have been known to be under the sway of the election-machine manufacturers, who wine and dine and lobby them in an effort to snag their business](https://www.newyorker.com/news/dispatch/election-hacking-lessons-from-the-2018-def-con-hackers-conference)"



## More election interference
- [Russia did it again in 2018](https://en.wikipedia.org/wiki/Russian_interference_in_the_2018_United_States_elections)
  - By generating discord on social media via highlighting social and economic differences
