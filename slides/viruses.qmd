...
![](images/viruses/pe-file-format.webp){fig-alt="Windows PE file format image"}
:::
- Parts:
  - DOS header
  - DOS stub
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Elf-layout--en.svg/693px-Elf-layout--en.svg.png){fig-alt="Linux ELF file format"}
:::
...
## Linking a PE file
::: {.right-float-img .img-size-600 .noboxshadow}
![](images/viruses/pe-linking.png){fig-alt="PE linking image"}
:::
...
## PE file expansion
![](images/viruses/pe-expansion.png){fig-alt="PE expansion image"}
...
::: {style="zoom:125%"}
![](images/viruses/vcl.png){fig-alt="virus creation laboratory screen shot"}
:::
...
::: {.right-float-img .img-size-800 style="zoom:125%"}
![](images/viruses/ngvck.gif){fig-alt="NGVCK screen shot"}
:::
