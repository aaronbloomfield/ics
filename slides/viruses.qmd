...
![Windows PE file format image](images/viruses/pe-file-format.webp)
:::
- Parts:
  - DOS header
  - DOS stub
...
![Linux ELF file format](https://upload.wikimedia.org/wikipedia/commons/thumb/7/77/Elf-layout--en.svg/693px-Elf-layout--en.svg.png)
:::
...
## Linking a PE file
::: {.right-float-img .img-size-600 .noboxshadow}
![PE linking image](images/viruses/pe-linking.png)
:::
...
## PE file expansion
![PE expansion image](images/viruses/pe-expansion.png)
...
::: {style="zoom:125%"}
![virus creation laboratory screen shot](images/viruses/vcl.png)
:::
...
::: {.right-float-img .img-size-800 style="zoom:125%"}
![NGVCK screen shot](images/viruses/ngvck.gif)
:::
