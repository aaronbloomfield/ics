...
![a diagram of the stack before the buffer overflow](images/buffer-overflows/overflow-stack-1.png)
:::
...
## Stack for vulnerable()
::: {.right-float-img .noboxshadow}
![a diagram of the stack part-way through the buffer overflow](images/buffer-overflows/overflow-stack-2.png)
:::
...
## Stack for vulnerable()
::: {.right-float-img .noboxshadow}
![a diagram of the stack after the buffer overflow](images/buffer-overflows/overflow-stack-3.png)
:::
...
## Stack for vulnerable()
::: {.right-float-img .noboxshadow}
![a diagram showing a return address to a stack location](images/buffer-overflows/return-to-stack.png)
:::
