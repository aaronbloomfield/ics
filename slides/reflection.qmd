...
## The 2018 version
- In the fall of 2018, various media companies tried to resurrect some aspects of SOPA & PIPA
...
![](https://cdn.shopify.com/s/files/1/0068/2142/products/wp-mk7_81d03a53-bf1a-426f-9425-a34c8b3d9c85_800x.jpg){fig-alt="an image of a USB pineapple"}
:::
- A $100 WiFi device
- Allows a MITM
...
![](images/reflection/cves-2023-12-02.webp){fig-alt="an image of the CVE home page"}
:::
...
- It doesn't always happen that way...
  - Some want to embarrass a company
...
![](images/reflection/cert-email.png){fig-alt="cert email"}
...
- Revised a few assignments (tricky jump was much smoother this time around)
...
<li><strike><a href='../hws/hw-buffer.html'>HW 11: Buffer Overflow</a></strike></li>
...
## Have a great break!
![](https://www.cs.virginia.edu/~asb2t/laststrip.png){fig-alt="calvin & hobbes goodbye"}
