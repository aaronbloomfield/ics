...
::: {.stretch}
![xkcd comic 327 showing an SQL injection attack](https://imgs.xkcd.com/comics/exploits_of_a_mom.png){title="Her daughter is named Help I&#39;m trapped in a driver&#39;s license factory." style='border:10px solid white' srcset="https://imgs.xkcd.com/comics/exploits_of_a_mom_2x.png 2x" }
:::
::: {.r-stack}
...
![a screenshot showing different HTML form input types](images/sql-xss-csrf/sample_web_form.png)
