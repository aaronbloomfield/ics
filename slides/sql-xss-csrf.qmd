...
::: {.stretch}
![](https://imgs.xkcd.com/comics/exploits_of_a_mom.png){fig-alt="xkcd comic 327 showing an SQL injection attack"}{title="Her daughter is named Help I&#39;m trapped in a driver&#39;s license factory." style='border:10px solid white' srcset="https://imgs.xkcd.com/comics/exploits_of_a_mom_2x.png 2x" }
:::
::: {.r-stack}
...
<p><img class="stretch" src="https://hackaday.com/wp-content/uploads/2014/04/18mpenleoksq8jpg.jpg" alt='a diagram of somebody trying to do an SQL injection attack through their license plate'></p>
...
- Attributes:
  ...
  - `method="post"`: how the data is sent
    - GET means it's a long URL: http://server.com/foo.php?username=userid&password=123
...
![](images/sql-xss-csrf/sample_web_form.png){fig-alt="a screenshot showing different HTML form input types"}
...
- An example link: 
``` html
https://site.com/post.php?title=MyTitle&content=Lorem.ipsum
```
