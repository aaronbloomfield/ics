...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/9/95/Bomb_icon.svg/350px-Bomb_icon.svg.png){fig-alt="an image of a logic bomb"}
:::
- Self-replicating: 	no
...
![](https://s-media-cache-ak0.pinimg.com/originals/98/31/91/983191ca276eb1227fd2f85960215b8c.jpg){fig-alt="an image of a trojan horse"}
:::
- Self-replicating:	no 
- Population growth: 	zero
- Parasitic: 		yes
...
## Back door
::: {.right-float-img .img-size-600}
![](http://img11.deviantart.net/8549/i/2012/129/b/b/door_ajar_by_layall-d4z3odw.jpg){fig-alt="an image of a back door"}
:::
- Self-replicating:	no 
- Population growth: 	zero
- Parasitic: 		possibly
...
![](https://upload.wikimedia.org/wikipedia/commons/thumb/9/94/Coronavirus._SARS-CoV-2.png/768px-Coronavirus._SARS-CoV-2.png){fig-alt="an image of a virus (biological)"}
:::
...
![](https://upload.wikimedia.org/wikipedia/commons/3/30/Regenwurm1.jpg){fig-alt="an image of a worm (biological)"}
:::
- Self-replicating:	yes 
- Population growth: 	positive
- Parasitic: 		no
...
## Rabbit
::: {.right-float-img .img-size-500}
![](https://upload.wikimedia.org/wikipedia/commons/3/37/Oryctolagus_cuniculus_Tasmania_2.jpg){fig-alt="an image of a rabbit (biological)"}
:::
- Self-replicating:	yes 
- Population growth: 	zero
- Parasitic: 		no
...
## Spyware
::: {.right-float-img .img-size-600}
![](http://4.bp.blogspot.com/-OdK2rCo-g9s/VGRyT8EwP6I/AAAAAAAAAK0/pSxTUYy699g/s1600/spyware.gif){fig-alt="an image of spyware on a computer"}
:::
- Self-replicating:	no
- Population growth: 	zero
- Parasitic: 		no
...
## Adware
::: {.right-float-img .img-size-500}
![](https://cdn.ttgtmedia.com/rms/onlineImages/security-adware.jpg){fig-alt="an image of adware on a computer"}
:::
- Self-replicating:	no 
- Population growth: 	zero
- Parasitic: 		no
...
## Droppers
::: {.right-float-img .img-size-500}
![](https://upload.wikimedia.org/wikipedia/commons/thumb/3/32/Pipette_tip_over_tube.jpg/548px-Pipette_tip_over_tube.jpg){fig-alt="an image of a dropper"}
:::
...
## Hybrids
::: {.right-float-img .img-size-500}
![](https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Chimera_d%27arezzo%2C_fi%2C_04.JPG/640px-Chimera_d%27arezzo%2C_fi%2C_04.JPG){fig-alt="an image of a chimera"}
:::
- Self-replicating:	n/a
- Population growth: 	n/a
- Parasitic: 		n/a
...
## Zombies
::: {.right-float-img .img-size-500}
![](https://upload.wikimedia.org/wikipedia/commons/thumb/a/ad/Zombie_haiti_ill_artlibre_jnl.png/434px-Zombie_haiti_ill_artlibre_jnl.png){fig-alt="an image of a zombie"}
:::
- Self-replicating:	?
- Population growth: 	?
...
## Botnet
::: {.right-float-img .img-size-600}
![](https://upload.wikimedia.org/wikipedia/commons/thumb/c/c0/Botnet2.gif/640px-Botnet2.gif){fig-alt="a diagram of a botnet"}
:::
- Self-replicating:	N/A
- Population growth: 	N/A
- Parasitic: 		yes
...
## Ransomware
::: {.right-float-img .img-size-600}
![](https://upload.wikimedia.org/wikipedia/commons/thumb/1/12/Ransomware-pic.jpg/640px-Ransomware-pic.jpg){fig-alt="a ransomware screen shot"}
:::
