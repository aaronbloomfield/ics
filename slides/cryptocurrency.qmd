...
![the US dollar bill](images/cryptocurrency/dollar-bill.webp)
:::
...
::: {.noboxshadow}
![the logo of the AaronDollar(TM)](images/cryptocurrency/aaron-dollar.png){style="background-color:transparent;height:400px"}
:::
...
![BTC symbol](images/cryptocurrency/btc-coin-symbol.svg){style="background-color:transparent"}
:::

<!-- .slide: class="right-float-img .img-size-300" -->
## A note about numbers...
::: {.right-float-img .img-size-600}
[![BTC symbol](images/cryptocurrency/bitcoin-coin.webp)](https://commons.wikimedia.org/wiki/File:One_bitcoin_sitting_atop_bundles_of_US_$100_notes.png)
:::
...
![a statue of Satoshi Nakamoto](https://upload.wikimedia.org/wikipedia/commons/7/77/Satoshi_Nakamoto.jpg)
:::
...
## Wallets
::: {.right-float-img .img-size-500}
![An image of a leather wallet](https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Czech_Wallet.jpg/800px-Czech_Wallet.jpg)
:::
...
::: {.right-float-img}
![a simple blockchain](images/cryptocurrency/overview.dot.1.svg)
:::
...
# Mining
::: {.cclogosubtitle .noboxshadow}
![BTC logo](images/cryptocurrency/btc-coin-symbol.svg){style="background-color:transparent"}
:::
...
## Target
::: {.right-float-img .img-size-500}
![archery target with arrows](https://upload.wikimedia.org/wikipedia/commons/d/dc/WA_archery_target_with_arrows.jpg)
:::
...
::: {.right-float-img .img-size-600}
![nvidia graphics card](https://upload.wikimedia.org/wikipedia/commons/4/48/Gigabyte_GTX_970_Windforce.jpg)
:::
...
## Electricity usage
::: {.right-float-img .img-size-500}
![electricity pylons](https://upload.wikimedia.org/wikipedia/commons/6/6b/Electricity_pylons2.jpg)
:::
...
![BTC hashes per second](images/cryptocurrency/btc-hashes-per-sec.webp)



## Mining hardware
::: {.right-float-img .img-size-500}
![BTC miner from Amazon](https://m.media-amazon.com/images/I/61WsmRwaOaL._AC_SL1000_.jpg)
:::
