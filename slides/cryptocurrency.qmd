...
![](images/cryptocurrency/dollar-bill.webp){fig-alt="the US dollar bill"}
:::
...
::: {.noboxshadow}
![](images/cryptocurrency/aaron-dollar.png){fig-alt="the logo of the AaronDollar(TM)"}{style="background-color:transparent;height:400px"}
:::
...
![](images/cryptocurrency/btc-coin-symbol.svg){fig-alt="BTC symbol"}{style="background-color:transparent"}
:::

<!-- .slide: class="right-float-img .img-size-300" -->
## A note about numbers...
::: {.right-float-img .img-size-600}
[![](images/cryptocurrency/bitcoin-coin.webp){fig-alt="BTC symbol"}](https://commons.wikimedia.org/wiki/File:One_bitcoin_sitting_atop_bundles_of_US_$100_notes.png)
:::
...
![](https://upload.wikimedia.org/wikipedia/commons/7/77/Satoshi_Nakamoto.jpg){fig-alt="a statue of Satoshi Nakamoto"}
:::
...
![](images/cryptocurrency/btc-price.webp){fig-alt="BTC price"}
...
## Wallets
::: {.right-float-img .img-size-500}
![](https://upload.wikimedia.org/wikipedia/commons/thumb/4/48/Czech_Wallet.jpg/800px-Czech_Wallet.jpg){fig-alt="An image of a leather wallet"}
:::
...
::: {.right-float-img}
![](images/cryptocurrency/overview.dot.1.svg){fig-alt="a simple blockchain"}
:::
...
# Mining
::: {.cclogosubtitle .noboxshadow}
![](images/cryptocurrency/btc-coin-symbol.svg){fig-alt="BTC logo"}{style="background-color:transparent"}
:::
...
## Target
::: {.right-float-img .img-size-500}
![](https://upload.wikimedia.org/wikipedia/commons/d/dc/WA_archery_target_with_arrows.jpg){fig-alt="archery target with arrows"}
:::
...
::: {.right-float-img .img-size-600}
![](https://upload.wikimedia.org/wikipedia/commons/4/48/Gigabyte_GTX_970_Windforce.jpg){fig-alt="nvidia graphics card"}
:::
...
## Electricity usage
::: {.right-float-img .img-size-500}
![](https://upload.wikimedia.org/wikipedia/commons/6/6b/Electricity_pylons2.jpg){fig-alt="electricity pylons"}
:::
...
![](images/cryptocurrency/btc-difficulty-all-time.webp){fig-alt="BTC difficulty, all time"}
<!-- change each semester -->
...
![](images/cryptocurrency/btc-difficulty-last-3-years.webp){fig-alt="BTC difficulty, last 2 years"}
<!-- change each semester -->
...
![](images/cryptocurrency/btc-hashes-per-sec.webp){fig-alt="BTC hashes per second"}



## Mining hardware
::: {.right-float-img .img-size-500}
![](https://m.media-amazon.com/images/I/61WsmRwaOaL._AC_SL1000_.jpg){fig-alt="BTC miner from Amazon"}
:::
