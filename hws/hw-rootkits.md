...
### Task 2: What else can rootkits do?
...
For this fourth task we are going to modify the source code to insert
...
The only file you should submit from this is the modified `md5sum.c`
